  ...
  <div class="card-body">
    <form method="post" action="{{route('product.update',$product->id)}}">
      ...
      <div class="form-group">
        ...
        <input type="checkbox" name="is_preOrder" id="is_preOrder" value="1" {{ $product->is_preOrder == 1 ? 'checked' : '' }}> Ya
      </div>

      <div class="form-group" id="estimatedDaysGroup" style="display: none;">
        <label for="estimated_days" class="col-form-label">
          Perkiraan Hari Pengiriman <span class="text-danger">*</span>
        </label>
        <input id="estimated_days" type="number" name="estimated_days" min="1" placeholder="Masukan perkiraan hari pengiriman" value="{{ $product->estimated_days }}" class="form-control">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const estimatedInput = document.getElementById('estimated_days');
