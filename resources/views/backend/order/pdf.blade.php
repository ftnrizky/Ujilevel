    ...
    @if ($order)
      ...
      @endif --}}
                    <tr>
                        <th scope="col" class="empty"></th>
                        @php
                            $shipping_data = DB::table('shippings')->where('id', $order->shipping_id)->first();
                            $shipping_price = $shipping_data ? $shipping_data->price : 0;
                        @endphp
                        <th scope="col" class="text-right ">Shipping:</th>
                        <th><span>${{ number_format($shipping_price, 2) }}</span></th>
                    </tr>
                    <tr>
                        <th scope="col" class="empty"></th>
