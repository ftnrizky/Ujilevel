<style>
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
          ...
          <i><img src="{{ asset('image/asset -ujilevel/house.png') }}"
              alt="" /></i>
          </a>
      </li>
      ...
      <a class="nav-link" href="#">
          <img src="{{ asset('image/asset -ujilevel/bell.png') }}" alt="" style="width: 20px; height: 20px;">
      </a>
      </li>
      ...
      <li class="nav-item dropdown no-arrow mx-1" id="messageT" data-url="{{route('messages.five')}}">
          ...
          <a class="nav-link" href="#">
          <img src="{{ asset('image/asset -ujilevel/comments.png') }}" alt="" style="width: 20px; height: 20px;">
          </a>
      </li>
