...
@endsection
@section('title','Stret Steredirs || PRODUCT DETAIL')
						...
						<div class="product-des">
							...
							<div class="short">
								<div class="top d-flex">
									...
									@if($product_detail->is_preOrder==true)
								...
								@if($product_detail->is_preOrder==true)
								<p class="text-danger fs-5 fw-bolder mt-3">Produk ini merupakan produk pre order dengan estimasi sampai dalam {{$product_detail->estimated_days}} hari</p>
								@endif
							...
							<div class="product-buy">
								<form action="{{route('single-add-to-cart')}}" method="POST">
									...
									<div class="add-to-cart mt-4 d-flex ">
