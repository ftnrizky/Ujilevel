                        ...
                        <tbody id="cart_item_list">
                            @if (Helper::getAllProductFromCart())
                                @foreach (Helper::getAllProductFromCart() as $key => $cart)
                                    ...
                                    <tr>
                                        <td class="image"><img src="{{ $photo[0] }}" alt="{{ $photo[0] }}"></td>
                                        ...
                                        <td class="total-amount cart_single_price text-center">
                                            <span class="money">Rp{{ number_format($cart->product->price * $cart->quantity) }}</span>
                                        </td>
                ...
                <div class="total-amount">
                    <div class="row">
                        <div class="col-lg-8 col-md-5 col-12">
                            <div class="left">
                                ...
                                <div class="checkbox">
                                    ...
                                    @endphp
                                    <label class="checkbox-inline"><input type="checkbox" onchange="showMe('shipping');"> Shipping</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                <ul>
                                    <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Total Belanja
                                        <span>Rp{{ number_format(Helper::totalCartPrice(), 2) }}</span>
                                    </li>

                                    @if (session()->has('coupon'))
                                        <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">Diskon
...
$(document).on('click', '.btn-number', function(e) {
    ...
    let input = $("input[name='quant[]'][data-id='" + button.closest('.input-group').find('.quantity-input').data('id') + "']");
