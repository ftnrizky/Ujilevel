...
Route::get('product-category/{slug}', 'ProductController@productByCategory')->name('product-cat');
Route::get('product-subcategory/{slug}/{sub_slug}', 'ProductController@productBySubCategory')->name('product-sub-cat');
// Cart section
...
Route::post('/order/upload-bukti/{order}', [OrderController::class, 'uploadBuktiPembayaran'])->name('order.upload.bukti')->middleware('auth');
...
Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/order/bayar', [PembayaranController::class, 'bayar'])->name('order.bayar');
    // Shipping
